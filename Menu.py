class Set :     
    # Creates an empty set instance and add 
#elements in it. 
   ...
   # Determines if this set is a subset of 
   ...
   # Creates a new set from the union of 
   ...
   # Creates a new set from the intersection: 
    ...
    # Creates a new set from the difference: 
    ...
    def difference( self, setB ): 
     ...
     # Creates the iterator for traversing the 
